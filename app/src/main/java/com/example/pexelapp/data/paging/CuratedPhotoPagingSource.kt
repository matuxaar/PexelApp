...
class CuratedPhotoPagingSource(private val photoService: PhotoService): PagingSource<Int, Photo>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Photo> {
        return try {
            ...
            val requestMap = mapOf("page" to pageIndex, "per_page" to params.loadSize)
